<template>
  <div>
    <d-alert class="alert-royal-blue" show>
      ...
      <strong>How you doin'?</strong> I'm just a friendly, good-looking
      notification message and I come in all the colors you can see below.
      Pretty cool, huh?
    </d-alert>
    ...
    <d-container fluid class="main-content-container px-4">
      ...
      <d-row class="mb-2">
        ...
        <d-col class="mb-4">
          <div
            class="bg-primary rounded text-white text-center p-4"
            style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"
          ></div>
        </d-col>
        <d-col class="mb-4">
          <div
            class="bg-secondary rounded text-white text-center p-4"
            style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"
          ></div>
        </d-col>
        <d-col class="mb-4">
          <div
            class="bg-success rounded text-white text-center p-4"
            style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"
          ></div>
        </d-col>
        <d-col class="mb-4">
          <div
            class="bg-info rounded text-white text-center p-4"
            style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"
          ></div>
        </d-col>
        <d-col class="mb-4">
          <div
            class="bg-warning rounded text-white text-center p-4"
            style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"
          ></div>
        </d-col>
        <d-col class="mb-4">
          <div
            class="bg-danger rounded text-white text-center p-4"
            style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"
          ></div>
        </d-col>
        <d-col class="mb-4">
          <div
            class="bg-dark rounded text-white text-center p-4"
            style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);"
          ></div>
        </d-col>
      </d-row>
          ...
          <d-card class="card-small mb-4">
            ...
            <d-list-group flush>
                ...
                <d-row>
                  ...
                  <d-col sm="12" md="4" class="mb-3">
                    ...
                    <fieldset>
                      ...
                      <d-checkbox toggle class="custom-toggle-sm" disabled>
                        Disabled
                      </d-checkbox>
                      <d-checkbox
                        toggle
              ...
              <d-list-group-item class="p-3">
                ...
                <d-row class="mb-3">
                  <d-col>
                    ...
                    <d-button size="sm" theme="secondary" class="mb-2 mr-1">
                      Secondary
                    </d-button>
                    <d-button size="sm" theme="success" class="mb-2 mr-1">
                      Success
                    </d-button>
                    <d-button size="sm" theme="danger" class="mb-2 mr-1">
                      Danger
                    </d-button>
                    <d-button size="sm" theme="warning" class="mb-2 mr-1">
                      Warning
                    </d-button>
                    <d-button size="sm" theme="info" class="mb-2 mr-1">
                      Info
                    </d-button>
                    <d-button size="sm" theme="dark" class="mb-2 mr-1">
                      Dark
                    </d-button>
                    <d-button size="sm" class="mb-2 btn-white mr-1">
                      White
                    </d-button>
                    <d-button size="sm" class="mb-2 btn-royal-blue mr-1">
                      Royal Blue
                    </d-button>
                    <d-button size="sm" class="mb-2 btn-java mr-1">
                      Java
                    </d-button>
                    <d-button size="sm" class="mb-2 btn-salmon mr-1">
                      Salmon
                    </d-button>
                  </d-col>
                </d-row>
                ...
                <d-row>
                  <d-col>
                    ...
                    <d-button size="sm" outline theme="info" class="mb-2 mr-1">
                      Info
                    </d-button>
                    <d-button size="sm" outline theme="dark" class="mb-2 mr-1">
                      Dark
                    </d-button>
                    <d-button size="sm" class="mb-2 btn-outline-light mr-1">
                      Light
                    </d-button>
                    <d-button
                      size="sm"
                      class="mb-2 btn-outline-royal-blue mr-1"
                    >
                      Royal Blue
                    </d-button>
                    <d-button size="sm" class="mb-2 btn-outline-java mr-1">
                      Java
                    </d-button>
                    <d-button size="sm" class="mb-2 btn-outline-salmon mr-1">
                      Salmon
                    </d-button>
                  </d-col>
                </d-row>
              ...
              <d-list-group-item class="p-3">
                ...
                <d-row>
                  <d-col>
                    <d-button theme="primary" class="mb-2 mr-1">
                      Primary
                    </d-button>
                    <d-button theme="secondary" class="mb-2 mr-1">
                      Secondary
                    </d-button>
                    <d-button theme="success" class="mb-2 mr-1">
                      Success
                    </d-button>
                    <d-button theme="danger" class="mb-2 mr-1">Danger</d-button>
                    <d-button theme="warning" class="mb-2 mr-1">
                      Warning
                    </d-button>
                    ...
                    <d-button class="mb-2 btn-royal-blue mr-1">
                      Royal Blue
                    </d-button>
                  </d-col>
                </d-row>
                ...
                <d-row>
                  <d-col>
                    <d-button outline theme="primary" class="mb-2 mr-1">
                      Primary
                    </d-button>
                    <d-button outline theme="secondary" class="mb-2 mr-1">
                      Secondary
                    </d-button>
                    <d-button outline theme="success" class="mb-2 mr-1">
                      Success
                    </d-button>
                    <d-button outline theme="danger" class="mb-2 mr-1">
                      Danger
                    </d-button>
                    <d-button outline theme="warning" class="mb-2 mr-1">
                      Warning
                    </d-button>
                    <d-button outline theme="info" class="mb-2 mr-1">
                      Info
                    </d-button>
                    <d-button outline theme="dark" class="mb-2 mr-1">
                      Dark
                    </d-button>
                    <d-button class="mb-2 btn-outline-light mr-1">
                      Light
                    </d-button>
                    <d-button class="mb-2 btn-outline-royal-blue mr-1">
                      Royal Blue
                    </d-button>
                  </d-col>
                </d-row>
            ...
            <d-list-group flush>
              ...
              <d-list-group-item class="px-3">
                <div class="mb-2 pb-1">
                  ...
                  <d-slider
                    class="slider-success my-4"
                    value="85"
                    :options="{ tooltips: true }"
                  />
                  <d-slider
                    class="slider-royal-blue my-4"
                    value="15"
                    :options="{ connect: [false, true] }"
                  />
                  <d-slider
                    class="my-4 mb-4"
                    :value="35"
