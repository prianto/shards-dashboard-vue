<template>
  <d-card class="card-small blog-comments">
    ...
    <d-card-body class="p-0">
      <div
        v-for="(discussion, idx) in discussionsData"
        :key="idx"
      ...
      >
        ...
        <div class="blog-comments__content">
          ...
          <div class="blog-comments__meta text-muted">
            <a class="text-secondary" :href="discussion.author.url">{{
              discussion.author.name
            }}</a>
            on
            <a class="text-secondary" :href="discussion.post.url">{{
          ...
          <div class="blog-comments__actions">
            <d-button-group size="small">
              <d-button
                class="btn-white"
                @click="handleClick('approve', discussion.id)"
              >
              ...
              <d-button
                class="btn-white"
                @click="handleClick('reject', discussion.id)"
              >
              ...
              <d-button
                class="btn-white"
                @click="handleClick('edit', discussion.id)"
              >
      ...
      <d-row>
        ...
        <d-col class="text-center view-report">
          <d-button
            type="submit"
            class="btn-white"
            @click="handleClick('view-all-comments')"
          >
            View All Comments
          </d-button>
        </d-col>
